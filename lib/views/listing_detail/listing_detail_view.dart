        ...
        Success(data: final l) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(l.imageUrls.first),
                      fit: BoxFit.cover,
                    ),
                  ),
                )
              ...
              Wrap(
                ...
                children: [
                  ...
                  StatusBadge(
                    ...
                    label: l.type == ListingType.trade
                        ? 'Trao đổi'
                        : 'Bán qua escrow',
                    prominent: true,
                  ),
              ...
              if (l.type != ListingType.sale &&
                  l.exchangeFor != null &&
                  l.exchangeFor!.isNotEmpty) ...[
                Text(
                  'Muốn đổi lấy',
                ...
                children: [
                  if (vm.isOwner) ...[
                    Container(
                      ...
                      child: IconButton(
                        icon: const Icon(Icons.edit_outlined, color: TradeLinkColors.onSurfaceVariant),
                        tooltip: 'Chỉnh sửa',
                    ...
                    Container(
                      ...
                      child: IconButton(
                        icon: const Icon(Icons.delete_outline, color: TradeLinkColors.error),
                        tooltip: 'Xóa tin',
                    ...
                    Expanded(
                      child: TradeLinkButton.secondary(
                        ...
                        onPressed: () =>
                            context.push('${AppPaths.sendOffer}/${l.id}'),
                      ),
                    ),
                    const SizedBox(width: TradeLinkSpacing.sm),
                  ],
                  if (!vm.isOwner)
                    Expanded(
                      child: TradeLinkButton.cta(
                        ...
                        onPressed: () => context.push('${AppPaths.createOrder}/${l.id}'),
